...
<div class="bg-indigo-600 px-8 pt-10 lg:pt-14 pb-16 flex justify-between items-center mb-3">
    <!-- title -->
    <h1 class="text-xl text-white">Buat Tipe Kepribadian Baru</h1>
</div>
    ...
    <div class="xl:col-span-1">
        <div class="card h-full shadow">
            ...
            <div class="border-b border-gray-300 px-5 py-4">
                <h2 class="font-semibold text-gray-700">Form Tambah Tipe Kepribadian</h2>
            </div>

            <div class="p-6">
                <form action="{{ route('personality_types.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <!-- Kategori Select -->
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            name="name"
                            class="border border-gray-300 text-gray-900 rounded focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2 px-3"
                            placeholder="Nama Tipe Kepribadian"
                            required
                        />
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea
                            ...
                            name="description"
                            class="border border-gray-300 text-gray-900 rounded focus:ring-indigo-600 focus:border-indigo-600 block w-full p-2 px-3"
                            placeholder="Deskripsi Tipe Kepribadian"
                            required
                            rows="5"
                        ></textarea>
                    </div>
